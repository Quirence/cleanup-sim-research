...
> адаптивное планирование миссии поиска и сбора плавающего мусора автономным
...
2. выбрать финальную научную ветку: сравнительное исследование или новый
   region/drift-aware планировщик;
3. провести path-budget-fair pre-final серию;
4. затем замораживать параметры и запускать 30 seed.
