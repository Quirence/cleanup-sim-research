...
Статус на 2026-09-05: задание выполнено частично в PR #4; код и пять серий сохранены. Итоги, уточнения и следующие действия: [ревью результатов](adaptive_mission_revision_review_2026-09-05.md). Историческое указание ниже на seed 100-129 как на финальный резерв устарело: они уже использованы в тяжелой calibration-серии проекта. Не запускать новые работы по этому заданию без чтения актуального статуса.
